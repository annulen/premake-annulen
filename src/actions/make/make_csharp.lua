...
--
	...
	function premake.make_csharp(prj)
		...
		if prj.makeprjheader then
			_p(table.concat(prj.makeprjheader, "\n"))
			_p('')
		end
		...
		-- User-defined section
		if prj.makeprjfooter then
			_p(table.concat(prj.makeprjfooter, "\n"))
			_p('')
		end
	end
...
--
	...
	function premake.gmake_cs_config(cfg, csc, cfglibs)
		...
		-- User-defined section
		if cfg.makeprjconfig and #cfg.makeprjconfig > 0 then
			_p(table.implode(cfg.makeprjconfig, '  ', '\n', ''))
		end
